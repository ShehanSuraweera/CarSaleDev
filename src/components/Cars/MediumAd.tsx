...
const MediumAd = ({
  ...
  return (
    <>
      <div className=" mb-7 relative   shadow-md mt-2 hover:shadow-2xl sm:mt-2 w-[325px] sm:w-[280px] overflow-hidden sm:h-[300px] md:w-[370px] md:h-[340px] h-[250px] lg:w-[400px] dark:bg-[#000B17]  rounded-lg   flex flex-col justify-center items-center hover:cursor-pointer  ">
        {pathname === "/profile" && (
